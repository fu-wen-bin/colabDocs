...
export default function Editor () {
  ...
  return (
    <div className="box-border flex h-full w-full relative">
      {/* 左侧目录栏 */}
      <div
        className={`box-border toc-sidebar h-full overflow-y-auto border-r border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 transition-all duration-300 ${
